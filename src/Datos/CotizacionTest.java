...
public class CotizacionTest {
	...
	public void testImporteTotal() {
		...
		Cotizacion cotizacion = new Cotizacion((String)datos[0], (Date)datos[1], (Date)datos[2], (long)datos[3], (String)datos[4], (Producto)datos[5], (double)datos[6], (int)datos[7], 6.96); 
